...
namespace generalgff
{
			...
			Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.pl_bot.Location = new System.Drawing.Point(0, 240);
			...
			this.gb_locale.Size = new System.Drawing.Size(164, 220);
			this.gb_locale.TabIndex = 1;
			this.gb_locale.TabStop = false;
			// 
			// rb_UTW
			// 
			this.rb_UTW.Location = new System.Drawing.Point(90, 195);
			this.rb_UTW.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTW.Name = "rb_UTW";
			this.rb_UTW.Size = new System.Drawing.Size(70, 20);
			this.rb_UTW.TabIndex = 19;
			this.rb_UTW.TabStop = true;
			this.rb_UTW.Text = "UTW";
			this.rb_UTW.UseVisualStyleBackColor = true;
			this.rb_UTW.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTT
			// 
			this.rb_UTT.Location = new System.Drawing.Point(90, 175);
			this.rb_UTT.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTT.Name = "rb_UTT";
			this.rb_UTT.Size = new System.Drawing.Size(70, 20);
			this.rb_UTT.TabIndex = 18;
			this.rb_UTT.TabStop = true;
			this.rb_UTT.Text = "UTT";
			this.rb_UTT.UseVisualStyleBackColor = true;
			this.rb_UTT.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTS
			// 
			this.rb_UTS.Location = new System.Drawing.Point(90, 155);
			this.rb_UTS.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTS.Name = "rb_UTS";
			this.rb_UTS.Size = new System.Drawing.Size(70, 20);
			this.rb_UTS.TabIndex = 17;
			this.rb_UTS.TabStop = true;
			this.rb_UTS.Text = "UTS";
			this.rb_UTS.UseVisualStyleBackColor = true;
			this.rb_UTS.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTP
			// 
			this.rb_UTP.Location = new System.Drawing.Point(90, 135);
			this.rb_UTP.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTP.Name = "rb_UTP";
			this.rb_UTP.Size = new System.Drawing.Size(70, 20);
			this.rb_UTP.TabIndex = 16;
			this.rb_UTP.TabStop = true;
			this.rb_UTP.Text = "UTP";
			this.rb_UTP.UseVisualStyleBackColor = true;
			this.rb_UTP.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTM
			// 
			this.rb_UTM.Location = new System.Drawing.Point(90, 115);
			this.rb_UTM.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTM.Name = "rb_UTM";
			this.rb_UTM.Size = new System.Drawing.Size(70, 20);
			this.rb_UTM.TabIndex = 15;
			this.rb_UTM.TabStop = true;
			this.rb_UTM.Text = "UTM";
			this.rb_UTM.UseVisualStyleBackColor = true;
			this.rb_UTM.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTI
			// 
			this.rb_UTI.Location = new System.Drawing.Point(90, 95);
			this.rb_UTI.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTI.Name = "rb_UTI";
			this.rb_UTI.Size = new System.Drawing.Size(70, 20);
			this.rb_UTI.TabIndex = 14;
			this.rb_UTI.TabStop = true;
			this.rb_UTI.Text = "UTI";
			this.rb_UTI.UseVisualStyleBackColor = true;
			this.rb_UTI.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTE
			// 
			this.rb_UTE.Location = new System.Drawing.Point(90, 75);
			this.rb_UTE.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTE.Name = "rb_UTE";
			this.rb_UTE.Size = new System.Drawing.Size(70, 20);
			this.rb_UTE.TabIndex = 13;
			this.rb_UTE.TabStop = true;
			this.rb_UTE.Text = "UTE";
			this.rb_UTE.UseVisualStyleBackColor = true;
			this.rb_UTE.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTD
			// 
			this.rb_UTD.Location = new System.Drawing.Point(90, 55);
			this.rb_UTD.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTD.Name = "rb_UTD";
			this.rb_UTD.Size = new System.Drawing.Size(70, 20);
			this.rb_UTD.TabIndex = 12;
			this.rb_UTD.TabStop = true;
			this.rb_UTD.Text = "UTD";
			this.rb_UTD.UseVisualStyleBackColor = true;
			this.rb_UTD.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UTC
			// 
			this.rb_UTC.Location = new System.Drawing.Point(90, 35);
			this.rb_UTC.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UTC.Name = "rb_UTC";
			this.rb_UTC.Size = new System.Drawing.Size(70, 20);
			this.rb_UTC.TabIndex = 11;
			this.rb_UTC.TabStop = true;
			this.rb_UTC.Text = "UTC";
			this.rb_UTC.UseVisualStyleBackColor = true;
			this.rb_UTC.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_IFO
			// 
			this.rb_IFO.Location = new System.Drawing.Point(10, 135);
			this.rb_IFO.Margin = new System.Windows.Forms.Padding(0);
			this.rb_IFO.Name = "rb_IFO";
			this.rb_IFO.Size = new System.Drawing.Size(70, 20);
			this.rb_IFO.TabIndex = 6;
			this.rb_IFO.TabStop = true;
			this.rb_IFO.Text = "IFO";
			this.rb_IFO.UseVisualStyleBackColor = true;
			this.rb_IFO.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_JRL
			// 
			this.rb_JRL.Location = new System.Drawing.Point(10, 155);
			this.rb_JRL.Margin = new System.Windows.Forms.Padding(0);
			this.rb_JRL.Name = "rb_JRL";
			this.rb_JRL.Size = new System.Drawing.Size(70, 20);
			this.rb_JRL.TabIndex = 7;
			this.rb_JRL.TabStop = true;
			this.rb_JRL.Text = "JRL";
			this.rb_JRL.UseVisualStyleBackColor = true;
			this.rb_JRL.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_ROS
			// 
			this.rb_ROS.Location = new System.Drawing.Point(10, 175);
			this.rb_ROS.Margin = new System.Windows.Forms.Padding(0);
			this.rb_ROS.Name = "rb_ROS";
			this.rb_ROS.Size = new System.Drawing.Size(70, 20);
			this.rb_ROS.TabIndex = 8;
			this.rb_ROS.TabStop = true;
			this.rb_ROS.Text = "ROS";
			this.rb_ROS.UseVisualStyleBackColor = true;
			this.rb_ROS.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_ULT
			// 
			this.rb_ULT.Location = new System.Drawing.Point(10, 195);
			this.rb_ULT.Margin = new System.Windows.Forms.Padding(0);
			this.rb_ULT.Name = "rb_ULT";
			this.rb_ULT.Size = new System.Drawing.Size(70, 20);
			this.rb_ULT.TabIndex = 9;
			this.rb_ULT.TabStop = true;
			this.rb_ULT.Text = "ULT";
			this.rb_ULT.UseVisualStyleBackColor = true;
			this.rb_ULT.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_UPE
			// 
			this.rb_UPE.Location = new System.Drawing.Point(90, 15);
			this.rb_UPE.Margin = new System.Windows.Forms.Padding(0);
			this.rb_UPE.Name = "rb_UPE";
			this.rb_UPE.Size = new System.Drawing.Size(70, 20);
			this.rb_UPE.TabIndex = 10;
			this.rb_UPE.TabStop = true;
			this.rb_UPE.Text = "UPE";
			this.rb_UPE.UseVisualStyleBackColor = true;
			this.rb_UPE.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_Gen
			// 
			this.rb_Gen.Location = new System.Drawing.Point(10, 15);
			...
			this.rb_Gen.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_ARE
			// 
			this.rb_ARE.Location = new System.Drawing.Point(10, 35);
			this.rb_ARE.Margin = new System.Windows.Forms.Padding(0);
			this.rb_ARE.Name = "rb_ARE";
			this.rb_ARE.Size = new System.Drawing.Size(70, 20);
			this.rb_ARE.TabIndex = 1;
			this.rb_ARE.TabStop = true;
			this.rb_ARE.Text = "ARE";
			this.rb_ARE.UseVisualStyleBackColor = true;
			this.rb_ARE.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_BIC
			// 
			this.rb_BIC.Location = new System.Drawing.Point(10, 55);
			this.rb_BIC.Margin = new System.Windows.Forms.Padding(0);
			this.rb_BIC.Name = "rb_BIC";
			this.rb_BIC.Size = new System.Drawing.Size(70, 20);
			this.rb_BIC.TabIndex = 2;
			this.rb_BIC.TabStop = true;
			this.rb_BIC.Text = "BIC";
			this.rb_BIC.UseVisualStyleBackColor = true;
			this.rb_BIC.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_FAC
			// 
			this.rb_FAC.Location = new System.Drawing.Point(10, 75);
			this.rb_FAC.Margin = new System.Windows.Forms.Padding(0);
			this.rb_FAC.Name = "rb_FAC";
			this.rb_FAC.Size = new System.Drawing.Size(70, 20);
			this.rb_FAC.TabIndex = 3;
			this.rb_FAC.TabStop = true;
			this.rb_FAC.Text = "FAC";
			this.rb_FAC.UseVisualStyleBackColor = true;
			this.rb_FAC.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_GIC
			// 
			this.rb_GIC.Location = new System.Drawing.Point(10, 95);
			this.rb_GIC.Margin = new System.Windows.Forms.Padding(0);
			this.rb_GIC.Name = "rb_GIC";
			this.rb_GIC.Size = new System.Drawing.Size(70, 20);
			this.rb_GIC.TabIndex = 4;
			this.rb_GIC.TabStop = true;
			this.rb_GIC.Text = "GIC";
			this.rb_GIC.UseVisualStyleBackColor = true;
			this.rb_GIC.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// rb_GIT
			// 
			this.rb_GIT.Location = new System.Drawing.Point(10, 115);
			this.rb_GIT.Margin = new System.Windows.Forms.Padding(0);
			this.rb_GIT.Name = "rb_GIT";
			this.rb_GIT.Size = new System.Drawing.Size(70, 20);
			this.rb_GIT.TabIndex = 5;
			this.rb_GIT.TabStop = true;
			this.rb_GIT.Text = "GIT";
			this.rb_GIT.UseVisualStyleBackColor = true;
			this.rb_GIT.CheckedChanged += new System.EventHandler(this.checkchanged_radio);
			// 
			// TypeDialog
			// 
			this.AcceptButton = this.bt_Accept;
			this.CancelButton = this.bt_Cancel;
			this.ClientSize = new System.Drawing.Size(164, 276);
